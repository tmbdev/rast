...
- **Template classes get their own headers.** Each template class generally lives in its own dedicated header file, regardless of the library's grouping scheme above.
